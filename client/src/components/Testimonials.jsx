...
const Testimonials = () => {
  return (
    ...
    pt-20 pb-30'>
        <Title title="What our Guest Say" subTitle="Discover why discering
        travel consistently choose QuickStay for their exclusive and luxerious accomodations around the world."/>
